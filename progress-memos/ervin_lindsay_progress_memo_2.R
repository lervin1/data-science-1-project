...
From this, we can tell that as the budget increases the revenue also increases. This means there is a positive correlation between budget and revenue. There seems to be a lot of overplotting, so that is something I will fix in the future.
